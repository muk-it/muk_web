...
openerp.med_preview_PreviewHandler =function (instance) {
...
instance.web.BaseHandler = instance.web.Class.extend({
...
instance.web.PDFHandler = instance.web.BaseHandler.extend({
	checkExtension: function(extension) {
...
instance.web.OpenOfficeHandler = instance.web.BaseHandler.extend({
	checkExtension: function(extension) {
