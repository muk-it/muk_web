...
openerp.muk_preview_msoffice_PreviewHandler =function(instance) {
...
instance.web.WordHandler = instance.web.PDFHandler.extend({
...
instance.web.PowerPointHandler =  instance.web.PDFHandler.extend({
	checkExtension: function(extension) {
...
instance.web.ExcelHandler = instance.web.BaseHandler.extend({
	checkExtension: function(extension) {
